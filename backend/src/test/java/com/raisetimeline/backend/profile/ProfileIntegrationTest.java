...
class ProfileIntegrationTest {
	...
	void getUserPostsReturnsOnlyThatUsersPosts() {
		...
		restTemplate.exchange(url("/api/posts"), HttpMethod.POST,
				authedBody(new PostRequest("alice post", null), alice.token()), PostResponse.class);
		restTemplate.exchange(url("/api/posts"), HttpMethod.POST,
				authedBody(new PostRequest("bob post", null), bob.token()), PostResponse.class);
